...
const Services = () => {
  ...
  useEffect(() => {
    document.body.classList.add('services-page-background');
    
    // Cleanup function to remove the class when component unmounts
    return () => {
      document.body.classList.remove('services-page-background');
    };
  }, []);
  ...
  return (
    <div className="app">
      <Header titles={["Главная", "Контакты"]} routes={["", "contacts"]} currentPage="УСЛУГИ"/>
